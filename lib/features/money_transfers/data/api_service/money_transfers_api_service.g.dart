...
class _MoneyTransfersApiService implements MoneyTransfersApiService {
  ...
  getMoneyTransferCurrencies() async {
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<BaseResponse<List<MoneyTransferCurrencyModel>>>(
          Options(method: 'GET', headers: _headers, extra: _extra)
              .compose(
                _dio.options,
                'user/currencies',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<List<MoneyTransferCurrencyModel>> _value;
    try {
      _value = BaseResponse<List<MoneyTransferCurrencyModel>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                  .map<MoneyTransferCurrencyModel>(
                    (i) => MoneyTransferCurrencyModel.fromJson(
  ...
  Future<BaseResponse<NoteCalculateModel>> noteCalculateMoneyTransfer(
    ...
    final _options = _setStreamType<BaseResponse<NoteCalculateModel>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'user/money-transfers/note-calculate',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<NoteCalculateModel> _value;
    try {
      _value = BaseResponse<NoteCalculateModel>.fromJson(
        _result.data!,
        (json) => NoteCalculateModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
