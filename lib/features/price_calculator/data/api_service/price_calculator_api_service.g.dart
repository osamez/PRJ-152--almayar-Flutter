...
part of 'price_calculator_api_service.dart';
...
class _PriceCalculatorApiService implements PriceCalculatorApiService {
  _PriceCalculatorApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<BaseResponse<PriceCalculatorResponseModel>> calculateShipmentPrice(
    ...
    final _options = _setStreamType<BaseResponse<PriceCalculatorResponseModel>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'user/calculate-shipment-price',
    ...
    late BaseResponse<PriceCalculatorResponseModel> _value;
    try {
      _value = BaseResponse<PriceCalculatorResponseModel>.fromJson(
        _result.data!,
        (json) =>
            PriceCalculatorResponseModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
