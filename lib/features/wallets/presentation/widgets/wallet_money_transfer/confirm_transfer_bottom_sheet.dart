...
class ConfirmTransferBottomSheet extends StatefulWidget {
  ...
  @override
  State<ConfirmTransferBottomSheet> createState() =>
      _ConfirmTransferBottomSheetState();
}

class _ConfirmTransferBottomSheetState
    extends State<ConfirmTransferBottomSheet> {
            ...
            AppElevatedButton(
              ...
              onPressed: () {
                if (_formKey.currentState!.validate()) {
                  context.read<WalletMoneyTransferCubit>().transfer();
                }
              },
            ),
          ],
